...
test("完整项目应通过验证", () => {
  const dir = createFixture("full-project", {
    ...
    ".claude/hooks/phase-guard.js": "// test",
    ".claude/hooks/phase-reminder.js": "// test",
    ".claude/hooks/startup-check.js": "// test",
...
test("state-file 策略，phase=3 应返回阶段3", () => {
  const DETECTOR_SRC = path.join(__dirname, "..", "src", "templates", "hooks", "lib", "phase-detector.js");
